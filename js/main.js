...
// ქორწინების ტექსტი გენდერის მიხედვით იცვლება
var MARITAL_TEXTS = {
  men: "მოსახლეობის 2014 წლის აღწერის მიხედვით, ქორწინებაში მყოფი მამაკაცების რაოდენობა რეგიონში, 15 წლისა და უფროს ასაკში, ყოველ ათას მამაკაცზე, 686-ს შეადგენდა, რაც 27 ერთეულით აღემატებოდა 2002 წლის აღწერის მონაცემებს. ქვრივი მამაკაცების რაოდენობა არ შეცვლილა და 27-ის ტოლი იყო. 4 ერთეულით გაიზარდა განქორწინებულ/განშორებული მამაკაცების რაოდენობა, რომელმაც 19 მამაკაცი შეადგინა. 2014 წელს რეგიონში 28 ერთეულით მეტი მამაკაცი იმყოფებოდა ქორწინებაში, ვიდრე საქართველოში. ქვემო ქართლში ასევე შედარებით დაბალი იყო ქვრივი და განშორებულ/განქორწინებული მამაკაცების რაოდენობაც.",
  women: "2002-2014 წლების აღწერათა შორის პერიოდში, ქვემო ქართლში, 15 წლისა და უფროსი ასაკის ქორწინებაში მყოფი ქალების რაოდენობა, ყოველ ათას ქალზე, 610-დან 640-მდე გაიზარდა. ასევე გაიზარდა ქვრივებისა და განქორწინებულ/განშორებულთა რაოდენობაც. 2014 წლის მოსახლეობის აღწერის თანახმად, რეგიონში 54 ერთეულით მეტი ქალი იმყოფებოდა ქორწინებაში, ვიდრე საქართველოში. საშუალო რესპუბლიკურ მაჩვენებელთან შედარებით, მნიშვნელოვნად დაბალი იყო ქვრივი ქალების რაოდენობა, ხოლო განქორწინებულ/განშორებულთა მაჩვენებელი მცირედ (ერთი ერთეულით) ჩამორჩებოდა საქართველოში არსებულ დონეს.",
};

function syncMaritalInfoText() {
  if (typeof MAP_INFO === "undefined" || !MAP_INFO.marital) return;
  MAP_INFO.marital.text = MARITAL_TEXTS[maritalGender] || MARITAL_TEXTS.men;
  MAP_INFO.marital.title =
    "ქორწინებითი მდგომარეობა — " +
    (maritalGender === "women" ? "ქალები" : "მამაკაცები");
  // თუ ინფო-ფანჯარა ღიაა, მაშინვე განვაახლოთ
  if (typeof mapInfoVisible !== "undefined" && mapInfoVisible) {
    showMapInfo("marital");
  }
}
...
var MAP_INFO = {
  ...
  marital: {
    ...
    text: 
      "მოსახლეობის 2014 წლის აღწერის მიხედვით, ქორწინებაში მყოფი მამაკაცების რაოდენობა რეგიონში, 15 წლისა და უფროს ასაკში, ყოველ ათას მამაკაცზე, 686-ს შეადგენდა, რაც 27 ერთეულით აღემატებოდა 2002 წლის აღწერის მონაცემებს. ქვრივი მამაკაცების რაოდენობა არ შეცვლილა და 27-ის ტოლი იყო. 4 ერთეულით გაიზარდა განქორწინებულ/განშორებული მამაკაცების რაოდენობა, რომელმაც 19 მამაკაცი შეადგინა. 2014 წელს რეგიონში 28 ერთეულით მეტი მამაკაცი იმყოფებოდა ქორწინებაში, ვიდრე საქართველოში. ქვემო ქართლში ასევე შედარებით დაბალი იყო ქვრივი და განშორებულ/განქორწინებული მამაკაცების რაოდენობაც.",
    author: "გიორგი მელაძე",
    cartographer: "გვანცა წირღვავა",
    source: "საქსტატი, საქართველოს მოსახლეობის აღწერა, 1989, 2014",
  },
  ...
  idp: {
    ...
    text: "1980-იან წლებში, სვანეთში ზვავების და მთიან აჭარაში მეწყრების შედეგად, უსახლკაროდ მრავალი ოჯახი დარჩა, რომლებიც ეკომიგრანტებად მოიხსენიებიან. სახელმწიფომ მათი დიდი ნაწილი ქვემო ქართლში ბერძნების, სომხების და აზერბაიჯანელებისგან შეძენილ სახლებში ჩაასახლა. 1991-1993 წლების საომარმა მოქმედებებმა სამხრეთ ოსეთსა და აფხაზეთში, შემდეგ კი 2008 წლის რუსეთ-საქართველოს აგვისტოს ომმა, დევნილთა ახალი ნაკადები წარმოშვა. მათი ნაწილი ცხინვალის რეგიონიდან და აფხაზეთიდან ქვემო ქართლში ჩაასახლეს.",
  ...
  botanica: {
    title: 
      "საქართველოს ბოტანიკურ-აგრონომიული არეები",
    text: 
      "ივანე ჯავახიშვილის ხელდასხმით შექმნილ რუკებს შორის გამორჩეულია „საქართველოს ბოტანიკურ-აგრონომიული არეების რუკა“, რომელიც დანართის სახით ერთვის მისი ნაშრომის — „საქართველოს ეკონომიური ისტორიის“ მეორე გამოცემას (1930). ამ ნაშრომში ავტორი წარმოაჩენს იმ სამეურნეო კულტურას, რომელსაც ქართველი ერი მოცემულ გეოგრაფიულ სივრცეში უძველესი დროიდან ქმნიდა. ამან თავის მხრივ, ქართველი ერის ეთნიკური კონსოლიდაცია და სახელმწიფოებრივი ჩამოყალიბება განაპირობა. თითქმის საუკუნეს ითვლის აღნიშნული რუკა, თუმცა მას დღემდე არ დაუკარგავს სამეცნიერო ღირებულება. რუკა ეფუძნება მრავალ ძველ წყაროს. მათ შორის განსაკუთრებული ადგილი უკავია ვახუშტი ბაგრატიონის თხზულებას „აღწერა სამეფოსა საქართველოსა“. რუკა დაცულია ხელნაწერთა ეროვნულ ცენტრში.",
    source:
  ...
  crop_zones: {
    ...
    text: 
      "ბუნების უსაზღვრო სიყვარული იყო ნიკო კეცხოველის მეცნიერული და ლიტერატურული შემოქმედების წყარო. იგი იყო საქართველოში ბოტანიკური სკოლის ერთ-ერთი დამაარსებელი, ეროვნული მეცნიერებათა აკადემიის ერთ-ერთი ფუძემდებელი, თბილისის სახელმწიფო უნივერსიტეტის რექტორი 1945-1952 წლებში და უნივერსიტეტის პირველი კორპუსის ბაღის განაშენიანების ხელმძღვანელი, ბოტანიკის სამეცნიერო-კვლევითი ინსტიტუტის დირექტორი. მისი სამეცნიერო შრომები ეხება საქართველოს მცენარეულ საფარს, გეობოტანიკურ დარაიონებას, მცენარეთა აღდგენისა და დაცვის პრობლემებს. ამ სულისკვეთების შემცველია მისი მხატვრული ნაწარმოებები, რომლებზეც მოზარდი თაობა უნდა იზრდებოდეს, ვინაიდან მშობლიური ბუნებისადმი სიყვარულს უღვიძებს.",
    author: "დალი ნიკოლაიშვილი",
    cartographer: "ანი შეროზია",
    source:
  ...
  land: {
    ...
    cartographer: "სალომე ნიკოლეიშვილი, სოფიო ხორბალაძე",
  },
  sun: {
    title: "მზის ნათება",
    text: 
      "მზის ენერგია სხვა ტრადიციული ენერგეტიკული წყაროებისგან განსხვავებით, პრაქტიკულად ამოუწურავია. ამავე დროს, იგი უხვი და სუფთა ენერგიის წყაროა, რადგან მომდინარეობს ისეთი წყაროდან, როგორიც მზეა. საქართველოს რეგიონებს შორის მზის ნათების წლიური ხანგრძლივობა მაღალია ქვემო და შიდა ქართლში, კახეთში და სამცხე-ჯავახეთში. მათგან, ყველაზე მაღალი მაჩვენებლით გამოირჩევა ქვემო ქართლის ვაკე, სადაც მზის ნათების წლიური ხანგრძლივობა 2500 საათს აჭარბებს. გარდაბნის მეტეოროლოგიური სადგურის მრავალწლიანი მონაცემებით, მზის ნათების ხანგრძლივობა ივლისში 300 საათს აღემატება, რაც ყველაზე მაღალია საქართველოში. მზის ენერგიის ელექტროენერგიად გარდაქმნა ხდება თანამედროვე ტექნოლოგიების გამოყენებით, ესენია: ფოტოელექტრონული (მზის პანელები) და თერმული ენერგიის კონცენტრაციის სისტემები (ლინზები და სარკეები). მათი გამოყენება შესაძლებელია საყოფაცხოვრებო, სამრეწველო და კომერციული მიზნებისთვის. სპეციალური დანადგარებით შესაძლებელია მზის ენერგიის თბურ ან ელექტროენერგიად გარდაქმნა. განასხვავებენ მზის თერმულ დანადგარებს და მზის ფოტოელემენტებს (მზის პანელებს). მათი ეფექტურობა დამოკიდებულია მზის გამოსხივებაზე და დანადგარის მარგი ქმედების კოეფიციენტზე.",
    cartographer: "გვანცა წირღვავა",
    source: "საქართველოს ეროვნული ატლასი, 2012; მზის სახლი, ბიზნეს-პარტნიორი",
  },
  agri: {
    title: 
      "სოფლის მეურნეობის პროექტების ბენეფიციარები",
    text: "",
    cartographer: "სალომე ნიკოლეიშვილი",
  ...
  agri_spec: {
    title: 
      "სოფლის მეურნეობის საწარმოო მიმართულება",
    text: 
      "არქეოლოგიურმა აღმოჩენებმა დაადასტურა განვითარებული სამიწათმოქმედო კულტურის არსებობა ძვ. წ. V-IV ათასწლეულში ქვემო ქართლის ტერიტორიაზე, კერძოდ, ქციის (ხრამის) ხეობის ქვემო ნაწილში. ამ მხარის ეკონომიკურ პროფილს, რომლის საფუძველი იყო მრავალმხრივი და პროდუქტიული სოფლის მეურნეობა, საუკუნეების მანძილზე განსაზღვრავდა ხელსაყრელი ბუნებრივ-გეოგრაფიული ფაქტორები: აგროკლიმატური პირობები, რელიეფი, ნოყიერი ნიადაგები, წყლის რესურსების სიუხვე. დღესაც, სოფლის მეურნეობა ქვემო ქართლის ეკონომიკის ერთ-ერთი წამყვანი დარგია და რეგიონის მთლიანი შიდა პროდუქტის 14.4%-ს მოიცავს, ხოლო აგრარული სექტორის საწარმოთა ბრუნვას მზარდი ხასიათი აქვს. 2000-იან წლებამდე, ქვემო ქართლი საქართველოს ყველა რეგიონს უსწრებდა სასოფლო-სამეურნეო ფართობების სიდიდითა და პროდუქციის საერთო ღირებულებით. თუმცა, ამჯერად, სახნავი მიწების წილით მიწის ფონდში უკვე მცირედ ჩამორჩება კახეთს. რეგიონის სასოფლო-სამეურნეო სპეციალიზაციაში მნიშვნელოვან როლს ასრულებს რელიეფი. ქვემო ქართლის ვაკესა და მთისწინეთში წამყვანი დარგია მემცენარეობა, ძირითადად, ბოსტნეული და ბაღჩეული კულტურები: კარტოფილი, პომიდორი, პარკოსნები, მწვანილი, აგრეთვე მარცვლეული. მთის არეალებში ძირითადია სახორცე-სარძევე მიმართულების მეცხოველეობა: მსხვილფეხა რქოსანი საქონლის მოშენება, მეცხვარეობა, მეფრინველეობა.",
    cartographer: 
      "სალომე ნიკოლეიშვილი, სოფიო ხორბალაძე",
  ...
  agrovlimat: {
    ...
    text: "სასოფლო-სამეურნეო კულტურების პროდუქტიულობას განსაზღვრავს აგროკლიმატური რესურსები — მზის რადიაცია, ჰაერისა და ნიადაგის ტემპერატურები, ატმოსფერული ნალექები, ქარები, წაყინვები და სხვ. აგროკლიმატური რესურსების შესწავლის საფუძველზე ხდება ტერიტორიის აგროკლიმატური დარაიონება, რომლის მეცნიერული შეფასების და რეკომენდაციების გათვალისწინება მნიშვნელოვანია სასოფლო-სამეურნეო კულტურების სწორად შერჩევისა და განლაგებისთვის. კლიმატის სასოფლო-სამეურნეო შეფასების მეცნიერული მიმართულება საქართველოში შექმნა აგროკლიმატოლოგმა, აკად. თეოფანე დავითაიამ, რომელიც გააგრძელეს გივი გაგუამ, გიორგი და მაია მელაძეებმა და სხვებმა. მნიშვნელოვანია ქვემო ქართლის რეგიონის ხვედრითი წილი საქართველოს სოფლის მეურნეობაში. ქვემო ქართლი იყო და არის თბილისისა და რუსთავის სასოფლო-სამეურნეო პროდუქტებით მთავარი მომმარაგებელი. ტერიტორიის აგროკლიმატური რესურსების შეფასება ხდება სითბოს და ტენის მაჩვენებლებით. მთავარი აგროკლიმატური მაჩვენებელია 10°C-ზე მაღალი საშუალო დღეღამური ტემპერატურების ჯამი. ტენით უზრუნველყოფის მიხედვით ტერიტორიის შეფასება ხდება დატენიანების მაჩვენებლით, რომელიც არის ნალექების შეფარდება აორთქლებადობასთან. აგროკლიმატური რესურსების შეფასებით შესაძლებელია აგროკლიმატური მახასიათებლების ეფექტურად გამოყენება.",
    author: "გივი გაგუა",
    source:
  ...
  landscape_antrop: {
    title: "ანთროპოგენული ლანდშაფტები",
    text: "პრაქტიკულად გარდაქმნილი ლანდშაფტები მოიცავს ვაკეებს, მოსახლეობის მაღალი სიმჭიდროვითა და სასოფლო-სამეურნეო სავარგულებით (ტერიტორიის 80%-ზე მეტი). ძლიერ შეცვლილია მთისწინეთის ლანდშაფტები, სადაც ასევე მაღალია მოსახლეობის სიმჭიდროვე და სასოფლო-სამეურნეო სავარგულებით ტერიტორიის დაფარულობა (50-80%). საშუალოდ შეცვლილია საძოვრებად გამოყენებული მაღალი მთის ალპური და სუბალპური ლანდშაფტები, მდინარეთა ტერასები და ქვედა მთის ლანდშაფტები, რომლებიც დასახლებათა სიახლოვის გამო, გარკვეულ დემოგრაფიულ ზემოქმედებას განიცდიან. საშუალო მთის ტყის ლანდშაფტების მნიშვნელოვან ტერიტორიაზე შენარჩუნებულია ბუნების პირვანდელი სახე.",
    author: "დალი ნიკოლაიშვილი",
    cartographer: "ანი შეროზია",
  ...
  landscape: {
    title: "ლანდშაფტები",
    text: "ტერიტორიის სიმცირის მიუხედავად, ქვემო ქართლის ბუნებრივი ლანდშაფტები საკმაოდ მრავალფეროვანია, რაც განპირობებულია რთული ოროგრაფიული პირობებით, დიდი ჰიფსომეტრიული ამპლიტუდით, ფლორისტული ოლქების მიჯნაზე მდებარეობით და სხვ. აქ წარმოდგენილია ლანდშაფტები, ვაკეების ველის მცენარეულობიდან (ქვემო ქართლის ვაკე) მაღალი მთის სუბალპურ და ალპურ მდელოებამდე (ჯავახეთისა და სამსრის ქედები). მრავალფეროვნებით გამოირჩევა ქვედა მთის ტყის ლანდშაფტები, ვინაიდან იგი მოქცეულია მთისწინეთისა და საშუალო მთის ტყის ლანდშაფტებს შორის. შესაბამისად აქ სხვადასხვა ჰიდროთერმული პირობებისათვის დამახასიათებელი მცენარეთა დაჯგუფებები გვხვდება. გაცილებით ერთგვაროვანია საშუალო მთის ტყისა და მაღალი მთის ლანდშაფტები.",
    author: "დალი ნიკოლაიშვილი",
    cartographer: "ანი შეროზია",
    source: "საქართველოს გეოგრაფიული ატლასი, 2018",
  },
  hazard: {
    ...
    text: "ქვემო ქართლის ტერიტორიაზე საშიში გეოლოგიური პროცესების ჩასახვა-განვითარების და რეაქტივაციის მთავარ პირობებთან (მორფოლოგია, გეოლოგიური აგებულება) და სხვა მაპროვოცირებელ ფაქტორებს (ტექტონიკა, სეისმურობა, ჰიდროგეოლოგიური და საინჟინრო-გეოლოგიური პირობები) შორის, ერთ-ერთ უმნიშვნელოვანესს წარმოადგენს კლიმატი. მხარეში საშიში გეოლოგიური პროცესების პერიოდული ზემოქმედებით მიყენებული ზიანის და საშიშროების რისკის მიხედვით, გამოიყოფა შემდეგი კატეგორიები: მაღალი, საშუალო და დაბალი. აღნიშნული კატეგორიების მიხედვით მაღალი საშიშროების რისკის ქვეშ მოქცეულია 17, საშუალოში — 80, ხოლო დაბალში — 266 დასახლებული პუნქტი.",
    author: "გიორგი გაფრინდაშვილი, რომან კუმლაძე",
    source: "გარემოს ეროვნული სააგენტო, გეოლ. ბიულეტენი, 2025",
  },
  groundwater: {
    title: "მიწისქვეშა მტკნარი წყლები",
    text: "ქვემო ქართლის რეგიონში გავრცელებული მიწისქვეშა მტკნარი წყლები საძიებო ჰიდროგეოლოგიური სამუშაოების საფუძველზე დეტალურად იქნა შესწავლილი. კვლევები XX საუკუნის 50-იანი წლებიდან დაიწყო და 90-იანი წლების დასაწყისამდე გრძელდებოდა, რაც ძირითადად დიდი ქალაქების სასმელი წყლით უზრუნველყოფის საჭიროებასთან იყო დაკავშირებული. ჩატარებული კვლევების საფუძველზე, მიწისქვეშა მტკნარი წყლის ბუნებრივი რესურსი ქვემო ქართლის მხარეში 26.65 მ³/წმ რაოდენობით შეფასდა, რაც საქართველოს მიწისქვეშა მტკნარი სასმელი წყლის მთლიანი ბუნებრივი რესურსის 5%-ს შეადგენს. საფონდო-ისტორიულ მასალებში ამ ტერიტორიაზე მიწისქვეშა მტკნარი წყლების მრავალი წყარო და ჭაბურღილია დაფიქსირებული, რომელთა უმრავლესობა დღესაც სასმელი წყლის ერთადერთ წყაროს წარმოადგენს რიგი სოფლების, თუ მსხვილი დასახლებული პუნქტებისთვის. ცნობილი „დაშბაშის წყაროები“ წყლის დაბალი მინერალიზაციისა და რაოდენობრივი მაჩვენებლების გამო (დებიტი — 4000 ლ/წმ, წყლის საერთო მინერალიზაცია — 0.2-0.3 გ/ლ) მუდმივად იქცევდა უცხოელი და ადგილობრივი სპეციალისტების ყურადღებას. გარდა იმისა, რომ აქ განვითარებული ტურისტული კომპლექსი ვიზიტორთათვის ერთ-ერთ საინტერესო ობიექტს წარმოადგენს, თავის დროზე „დაშბაშის წყაროები“ საქართველოს მტკნარი წყლის მნიშვნელოვანი საბადოების ნუსხაში შევიდა. მიწისქვეშა წყლების საყურადღებო გამოვლინებებია ასევე „ოზნის წყაროები“ (დებიტი — 4977 ლ/წმ, მინერალიზაცია — 0.1-0.2 გ/ლ) და „ნარდევნის წყარო“ (დებიტი — 1620 ლ/წმ, მინერალიზაცია — 0.1-0.2 გ/ლ). კომპლექსური ჰიდროგეოლოგიური კვლევები ქვემო ქართლის მხარეში, 1990-იანი წლების დასაწყისიდან აღარ ჩატარებულა. უახლესი ინფორმაციის შეგროვება მიწისქვეშა წყლების რაოდენობრივი და ხარისხობრივი მახასიათებლების შესახებ 2013 წლიდან, სსიპ გარემოს ეროვნული სააგენტოს მიერ, ჰიდროგეოლოგიური მონიტორინგის ფარგლებში დაიწყო. სოფ. ვახტანგისში, სოფ. აზიზქენდსა და სოფ. ქვემო ბოლნისში არსებულ არტეზიულ ჭაბურღილებზე ავტომატური სადგურები მოეწყო, რომლებიც წყლის ძირითადი რაოდენობრივი და ხარისხობრივი მონაცემების მოწოდებას დისტანციურ რეჟიმში უზრუნველყოფს. აღნიშნული წყალპუნქტები ადგილობრივი მოსახლეობისთვის წყალმომარაგების დეცენტრალიზებულ წყაროს წარმოადგენს. მიწისქვეშა მტკნარი სასმელი წყლების მონიტორინგის ქსელის გაფართოება და მონაცემთა ბაზის განახლება ერთ-ერთ მნიშვნელოვან კომპონენტს წარმოადგენს რეგიონში წყლის რესურსების მართვისა და დაცვის მიზნით.",
    author: "ნანა ქიტიაშვილი",
    cartographer: "რომან კუმლაძე",
    source: "გარემოს ეროვნული სააგენტო, 2025",
  },
  earthquakes: {
    title: "მიწისძვრები",
    text: "მიწისძვრა დედამიწაზე არსებული სტიქიური მოვლენებიდან ერთ-ერთია, რომლის გამომწვევი მიზეზი ლითოსფეროს ფილების მოძრაობა და შეჯახებაა. სამხრეთ კავკასიის რეგიონში სეისმური აქტიურობა გამოწვეულია არაბეთის ფილის მოძრაობით ჩრდილოეთით, ევრაზიის ფილისკენ. შეჯახების შედეგად წარმოქმნილი ენერგია ზედაპირზე სხვადასხვა ეფექტით ვლინდება. საქართველო კატასტროფების რისკის ინდექსის მიხედვით საშუალო და მაღალი რისკის ქვეყანაა. აქ უძლიერესი მიწისძვრები (მაგნიტუდა > 8.0) არ ხდება, ხოლო ძლიერი მიწისძვრები (მაგნიტუდა ≈ 7.0) საუკუნეების ინტერვალით მეორდება. საქართველოს მიწისძვრების შესახებ მონაცემები ორი სახისაა: ისტორიული (1900 წლამდე) და ინსტრუმენტული (1900 წლის შემდეგ). საქართველოში სეისმურად აქტიურია კავკასიონი და ჯავახეთი, სადაც სუსტი მიწისძვრები, 2.2 მაგნიტუდაზე ნაკლები, თითქმის ყოველდღიურად ხდება. მათ ადამიანი ვერც კი გრძნობს, მაგრამ ხელსაწყო სეისმოგრაფი სეისმოგრამაზე აფიქსირებს. საქართველოში ყველაზე ძლიერი, 7 მაგნიტუდის მიწისძვრა, მოხდა 1991 წლის 29 აპრილს რაჭაში, ქალაქ ამბროლაურის მახლობლად. ქვემო ქართლში გახშირებული მიწისძვრებით ყურადღებას იქცევს დმანისის მუნიციპალიტეტი. იგი ესაზღვრება ჯავახეთს, რომლის რელიეფი ტექტონიკური და ვულკანური პროცესების მონაწილეობით შეიქმნა. ჯავახეთის ქედის კრატერებიდან ამოღვრილი ლავებით არის აგებული ქვემო ქართლის დმანისის და გომარეთის პლატოები. აქ გახშირებული, 3-4 მაგნიტუდის სიმძლავრის მიწისძვრები, პოსტვულკანურ აქტივობებად არის მიჩნეული.",
    author: "",
  ...
  forest: {
    title: "ტყეები",
    text: "ქვემო ქართლის ტყეებში წამყვანია ფოთლოვნეები: წიფელი, რცხილა, ჯაგრცხილა და მუხა. წიწვოვნებიდან ალგეთის სათავეებში გავრცელებულია ნაძვი და სოჭი. რცხილნარების უმეტესობა განვითარებულია წიფლნარებისა და მუხნარების განაჩეხ ადგილებზე, იშვიათად კი — ნახანძრალებზე. ალგეთისა და ხრამის აუზებში შემორჩენილია არიდული მეჩხერი (ნათელი) ტყის ნაშთები — საკმლის ხის, აკაკის ხისა და ღვიის კორომების სახით, ქართული ნეკერჩხლის, ძეძვისა და სხვათა მონაწილეობით. ამავე მდინარეების ქვემო წელის ხეობებში ჭალის ტყის ფრაგმენტებია, დმანისისა და გომარეთის პლატოებზე კი — მაღალი მთის ველები. სუბალპური მდელოები მხოლოდ ჯავახეთისა და თრიალეთის ქედების თხემებზე ვრცელდება ფრაგმენტულად. კიდევ უფრო შეზღუდული გავრცელებისაა ალპური მდელოები.",
    author: "ლერი ჭოჭუა",
    cartographer: "ანი შეროზია",
  ...
  vegetation: {
    ...
    author: "ნ. კეცხოველი",
    cartographer: "ანი შეროზია",
    source: "საქართველოს სსრ ატლასი, 1964",
  },
  soils: {
    title: "ნიადაგის ტიპები",
    text: "2019 წ. პროფ. თენგიზ ურუშაძის რედაქტორობით გამოიცა ქართველ ნიადაგმცოდნეთა ჯგუფის მიერ შედგენილი და 1999 წ. გამოცემული საქართველოს ნიადაგების რუკის განახლებული ვერსია. ნიადაგების ეროვნული კლასიფიკაცია შეჯერებულია ნიადაგების რესურსების მსოფლიო მონაცემთა ბაზების კლასიფიკაციასთან.",
    author: "თ. ურუშაძე",
    cartographer: "თამარ ჭიჭინაძე",
  ...
  soils_born: {
    ...
    text: "ნიადაგი ბუნებრივი ლანდშაფტის განსაკუთრებული კომპონენტია სამი სივრცობრივი და ერთი დროითი განზომილებით. იგი ყალიბდება ლითოსფეროს ზედა ფენაში ნიადაგწარმომქმნელი ქანების გამოფიტვის შედეგად. ნიადაგის მთავარი თვისებაა მისი ნაყოფიერება, რომელიც გულისხმობს მცენარის წყლით, სითბოთი და საკვები ნივთიერებით უზრუნველყოფას. ნიადაგი და მასზე არსებული მცენარეულობა ქმნის ერთიან სისტემას. ნიადაგი სასოფლო-სამეურნეო წარმოების მთავარი საშუალებაა. მასზეა დამოკიდებული სოფლის მეურნეობის დარგების განვითარება. ქვემო ქართლის ტერიტორიის მცირე ჰიფსომეტრიული განვრცობის გამო მის ტერიტორიაზე წარმოდგენილი ნიადაგ-მცენარეული საფარი დიდი მრავალფეროვნებით არ გამოირჩევა.",
    cartographer: "თამარ ჭიჭინაძე",
    source: "საქართველოს ნიადაგების რუკა, 1:500 000, 2019",
    author: "თ. ურუშაძე",
  },
  ...
  hot_days: {
    title: "ცხელი დღეების საშუალო რაოდენობა, 1990-2022",
    text:
  ...
  trop_nights: {
    title: "ტროპიკული ღამეების საშუალო რაოდენობა, 1990-2022",
    text:
      "კლიმატის ცვლილების პროცესი ქვემო ქართლში მნიშვნელოვნადაა გააქტიურებული. რეგიონის მთელ ტერიტორიაზე ჰაერის საშუალო წლიური ტემპერატურა საშუალოდ 0.7°C-ით არის მომატებული. ნალექების წლიური რაოდენობა ქვემო ქართლის ზოგ მუნიციპალიტეტში გაზრდილი, ხოლო ზოგან პირიქით, შემცირებულია. შეინიშნება სტიქიური ჰიდრომეტეოროლოგიური მოვლენების სიხშირისა და ინტენსივობის ზრდის ტენდენცია. გლობალური დათბობა და მასთან დაკავშირებული სითბური ტალღები ადამიანის ჯანმრთელობაზეც მნიშვნელოვან უარყოფით გავლენას ახდენს. პროგნოზების მიხედვით, საქართველოში იმატებს როგორც მზიანი დღეების, ასევე ცხელი დღეების (დღის ტემპერატურა 30°C-ს აღემატება) და ტროპიკული ღამეების (ღამის ტემპერატურა 20°C-ს აღემატება) რაოდენობაც. ადამიანისთვის სიგრილის მინიმალური ტემპერატურა 18°C, ხოლო სიცხის — 23°C-ია. რამდენიმე დღის მანძილზე გაგრძელებული ექსტრემალურად მაღალი ტემპერატურა ხელს უწყობს ინფექციური პათოლოგიების გახშირებას და ამწვავებს ქრონიკულ დაავადებებს (გულსისხლძარღვთა, სასუნთქი სისტემის და სხვ.). განსაკუთრებით მოწყვლადი ჯგუფები არიან: ბავშვები, ხანდაზმულები და ქრონიკული დაავადებების მქონე პირები. კლიმატის ცვლილების შეჩერება შეუძლებელია, თუმცა სწორი პოლიტიკის შემთხვევაში შესაძლებელია კლიმატური რისკების შემცირება, მზადყოფნა და შერბილება.",
    author: "ნანა ბოლაშვილი",
    cartographer: "ნიკოლოზ სუქნიძე",
  ...
  frost_days: {
    title: "ყინვიანი დღეების საშუალო რაოდენობა, 1990-2022",
    text:
      "კლიმატის ცვლილების პროცესი ქვემო ქართლში მნიშვნელოვნადაა გააქტიურებული. რეგიონის მთელ ტერიტორიაზე ჰაერის საშუალო წლიური ტემპერატურა საშუალოდ 0.7°C-ით არის მომატებული. ნალექების წლიური რაოდენობა ქვემო ქართლის ზოგ მუნიციპალიტეტში გაზრდილი, ხოლო ზოგან პირიქით, შემცირებულია. შეინიშნება სტიქიური ჰიდრომეტეოროლოგიური მოვლენების სიხშირისა და ინტენსივობის ზრდის ტენდენცია. გლობალური დათბობა და მასთან დაკავშირებული სითბური ტალღები ადამიანის ჯანმრთელობაზეც მნიშვნელოვან უარყოფით გავლენას ახდენს. პროგნოზების მიხედვით, საქართველოში იმატებს როგორც მზიანი დღეების, ასევე ცხელი დღეების (დღის ტემპერატურა 30°C-ს აღემატება) და ტროპიკული ღამეების (ღამის ტემპერატურა 20°C-ს აღემატება) რაოდენობაც. ადამიანისთვის სიგრილის მინიმალური ტემპერატურა 18°C, ხოლო სიცხის — 23°C-ია. რამდენიმე დღის მანძილზე გაგრძელებული ექსტრემალურად მაღალი ტემპერატურა ხელს უწყობს ინფექციური პათოლოგიების გახშირებას და ამწვავებს ქრონიკულ დაავადებებს (გულსისხლძარღვთა, სასუნთქი სისტემის და სხვ.). განსაკუთრებით მოწყვლადი ჯგუფები არიან: ბავშვები, ხანდაზმულები და ქრონიკული დაავადებების მქონე პირები. კლიმატის ცვლილების შეჩერება შეუძლებელია, თუმცა სწორი პოლიტიკის შემთხვევაში შესაძლებელია კლიმატური რისკების შემცირება, მზადყოფნა და შერბილება.",
    author: "ნანა ბოლაშვილი",
    cartographer: "ნიკოლოზ სუქნიძე",
  ...
  heat_waves: {
    title: "სითბური ტალღების სიხშირის ტენდენცია, 1990-2022",
    text:
  ...
  drought: {
    title: "გვალვის ინდექსი, 1990-2022",
    text: "",
    author: "ნანა ბოლაშვილი",
    cartographer: "ნიკოლოზ სუქნიძე",
    source: "E-OBS data access months (copernicus.eu)",
  ...
  archaeology: {
    title: "არქეოლოგია",
    text: 
      "არქეოლოგიურ კვლევებს კაცობრიობის ისტორიის წარსულის შესწავლისთვის უდიდესი მნიშვნელობა აქვს. დიდია მისი როლი წერილობითი წყაროების ცნობების დაზუსტებაში. ნივთიერი ძეგლების მოსაპოვებლად ტარდება არქეოლოგიური გათხრები, განისაზღვრება გათხრების შედეგად მოპოვებული ნივთიერი ძეგლების ასაკი, რის შემდეგ არქეოლოგიური ძეგლები ისტორიულ წყაროდ იქცევა. არქეოლოგიურ ძეგლებს განეკუთვნება ყველაფერი, რასაც ადამიანის არსებობისა და მოქმედების კვალი ეტყობა: ნასახლარები, ნასოფლარები, ნაქალაქარები, თავდაცვითი, საკულტო და სამეურნეო ნაგებობების ნანგრევები და სხვ. ისინი ძირითადად მიწით არის დაფარული და მათი გამოვლენა არქეოლოგიური გათხრებით ხდება.",
  ...
  fortifications: {
    ...
    text: 
      "საქართველოს რეგიონებს შორის ქვემო ქართლი თავდაცვითი ნაგებობების სიმრავლით და მრავალსახეობით გამოირჩევა. თავდაცვითი ნაგებობებიდან აქ დღემდეა შემორჩენილი: მეგალითური (ციკლოპური) ციხე, ციხექალაქი, ციხესიმაგრე, კოშკი, გამოქვაბული, რომელთაც დამპყრობლებისგან თავდაცვისა და უსაფრთხოების უზრუნველყოფის მიზნით აშენებდნენ. განსაკუთრებული ყურადღება ექცეოდა ნაგებობის მიუვალ, სტრატეგიულად მნიშვნელოვან ადგილებში აგებას, საიდანაც გზების კონტროლი იყო შესაძლებელი. ერთ-ერთი მნიშვნელოვანი ადგილი იყო ორი მდინარის შესართავი, სადაც ციხესიმაგრე ორი მხრიდან ბუნებრივად იყო დაცული. ციხესიმაგრეები ერთიანი თავდაცვითი ქსელის შექმნის პრინციპით იგებოდა, რაც თავდაცვითი ნაგებობის ერთიან საფორტიფიკაციო ქსელში ჩართვას უზრუნველყოფდა. ძირითადად ისინი ერთმანეთს კოშკების მეშვეობით უკავშირდებოდნენ. კოშკებზე გუშაგის მიერ დანთებული ცეცხლი ციხეებისთვის განგაშის ნიშანი იყო. მოგვიანებით, ცეცხლი ხმოვანმა სიგნალმა შეცვალა. უძველესი სახეობის სიმაგრეებია ციკლოპური ციხეები, რომლებიც მეგალითურ კულტურას მიეკუთვნება. ისინი მრავლადაა შემორჩენილი წალკის მუნიციპალიტეტში (ძვ. წ. II ათასწლეულის მეორე ნახევარი — ახ. წ. I ათასწლეულის პირველი ნახევარი). ციხეები აგებული იყო სხვადასხვა ზომის დაუმუშავებელი, ან უხეშად დამუშავებული ქვების მშრალი წყობით. ბუნებრივი ზღუდეებით და ადამიანის მიერ შექმნილი დამცავი ნაგებობებით იქმნებოდა კონკრეტული ადგილის თავდაცვითი სისტემა.",
  ...
  eparchies: {
    title: "ეპარქიები",
    text: 
      "ქვემო ქართლის რეგიონში საქართველოს მართლმადიდებელი ეკლესიის 7 ეპარქიაა (ბერძნ. επαρχία, ნიშნავს ქრისტიანული ეკლესიის ტერიტორიულ ერთეულს). ეპარქიების საზღვრები ძირითადად ემთხვევა ადმინისტრაციულ-ტერიტორიული ერთეულების საზღვრებს. თითოეულ ეპარქიას აქვს ერთი ან მეტი საეპისკოპოსო საკათედრო ტაძარი, საეპისკოპოსო რეზიდენცია, მოქმედი დედათა და მამათა მონასტრები, ჰყავს წმინდა სინოდის მიერ დადგენილი მღვდელმთავარი. ყოველი ეპარქია ექვემდებარება საქართველოს კათალიკოსს.",
    author: "თამარ ცხაკაია, თამარ ჭიჭინაძე",
    source: "საქართველოს ეკლესიის კალენდარი, 2024; საქართველოს საპატრიარქო",
  },
  petroglyphs: {
    title: "პეტროგლიფები",
    text: 
      "პეტროგლიფი (ბერძნ. პეტროს — ქვა, კლდე, გლიფი — ამოჭრა, ამოკვეთა) გამოქვაბულების კედლებზე, ჭერზე, კლდეებზე, ცალკეულ ქვებზე შესრულებული უძველესი გამოსახულებებია. მიეკუთვნება სხვადასხვა ეპოქას — პალეოლითიდან შუა საუკუნეებამდე. მკვლევართა აზრით, ამ გამოსახულებებს გარკვეულწილად მაგიური მნიშვნელობაც უნდა ჰქონოდა. შესრულების სტილის მიხედვით, არსებობს პოლიქრომული (ფერადი საღებავებით შესრულებული) და გრავიურული (ამოტეხვის ან ამოკაწვრის მეთოდით მიღებული) გამოსახულებები. ევროპის და აფრიკის ქვეყნების მხატვრობაში წამყვანი იყო ნადირობის და ბრძოლების რიტუალების ამსახველი სცენები. აზიის ქვეყნების მხატვრობაში — ნადირობის, გარეული და შინაური ცხოველების, მაგიური ნიშნების, მიწათმოქმედების სცენების. უცხოეთის სამეცნიერო წრეებში პეტროგლიფების კვლევა საპასუხისმგებლო და მნიშვნელოვანი სფეროა. მათი მოკვლევის ადგილებზე ეროვნული პარკებია შექმნილი. პეტროგლიფები საქართველოს მთელ ტერიტორიაზე გვხვდება. დიდი ნაწილი განადგურების პირასაა. 1950-იან წლებში იყო მათი აღწერის მცდელობა, თუმცა, მივიწყებას მიეცა. 1970-იან წლებში ჩატარდა თრიალეთის არქეოლოგიური ექსპედიცია მ. გაბუნიას ხელმძღვანელობით. აქ აღმოჩენილი უდიდესი ისტორიულ-კულტურული ღირებულების მქონე პეტროგლიფები დღეს უკვე განადგურების პირასაა. მათზე გამოსახულია: ცხენი, ირემი, ჯიხვი, აქლემი, მელა, შველი, ლომი და სხვ. პეტროგლიფების სიღრმისეული შესწავლის და კვლევის ეტაპი საქართველოში 2001 წლიდან დაიწყო, ხოლო 2010 წლიდან დღემდე აქტიურად მიმდინარეობს. სავარაუდოდ, ბევრი პეტროგლიფი ისევ მიწითაა დაფარული და აღმოჩენას ელის.",
  ...
  megaliths: {
    title: "მეგალითები",
    text: 
      "მეგალითი (მეგა — დიდი, ლითოს — ქვა) უზარმაზარი, მეტწილად დაუმუშავებელი ქვის დიდი მონუმენტი ან ლოდებისგან აგებული ნაგებობაა, რომელიც ძირითადად ენეოლითის და ბრინჯაოს ხანით თარიღდება (ძვ. წ. III-II ათასწლეულები). გავრცელებულია მთელ მსოფლიოში ავსტრალიის გარდა. ძველ საბერძნეთში მათ მშენებლობას მითიურ გოლიათებს — ციკლოპებს უკავშირებდნენ, ამიტომ მას ციკლოპურსაც უწოდებენ. ქართულ ისტორიულ წყაროებში უძველესი სიმაგრეების აშენებას „გმირებს“, ზეპირსიტყვიერებაში კი — დევებს, ან ამირანს მიაწერდნენ. საქართველოში არსებული/აღწერილი მეგალითური ნაგებობებია: მენჰირი (მიცვალებულთა სახლი), დოლმენი (საცხოვრისი ან სამარხი ნაგებობა), ყორღანი (ხელოვნური გორასამარხი), დარანი (მიწისქვეშა ან კლდის ნაგებობა), მეგალითური სამლოცველო, საცხოვრებელი და თავდაცვითი კომპლექსები. ქვემო ქართლის ტერიტორიაზე დღეს არსებული საფორტიფიკაციო ნაგებობები მხოლოდ ქვის მშრალი წყობით აშენებული ციკლოპური სიმაგრეებია. დასახლებების დაცვის მიზნით, ისინი მისასვლელებთან იგებოდა და მდგრადი მაღალი კედლით ბუნებრივ ზღუდეებთან ერთად ერთიან თავდაცვით სისტემას ქმნიდა. დღეისათვის, ციკლოპური ნაგებობების კედლები ჩამოშლილი ან დაშლილია მეორადი გამოყენებისთვის. საქართველოში მეგალითური ნაგებობები აღწერილია სამცხე-ჯავახეთში, ქვემო ქართლსა და აფხაზეთში. ქვემო ქართლში აღწერილი 62 მეგალითური ნაგებობიდან 27 წალკის მუნიციპალიტეტშია. ეროვნული მნიშვნელობის კატეგორიის კულტურის უძრავი ძეგლის სტატუსის მქონე 6 ძეგლიდან 5 წალკის პლატოზე, ერთი კი — ქვემო ქართლის პლატოზე მდებარეობს.",
  ...
  hail: {
    title: "სეტყვა",
    text: "სეტყვა ატმოსფერული ნალექია, რომელიც ყინულის სხვადასხვა ზომის სფერული ნაწილაკების ან ნატეხებისგან შედგება. ძირითადად მოდის წლის თბილ პერიოდში და დიდ ზიანს აყენებს სოფლის მეურნეობას. სეტყვის ტერიტორიული განაწილება დამოკიდებულია ოროგრაფიულ პირობებზე და იმ რთულ ფიზიკურ პროცესებზე, რომლებიც სეტყვის ღრუბლებში მიმდინარეობს. ახასიათებს ფრაგმენტული გავრცელება, შეიძლება დაისეტყვოს ერთი სოფელი, მის მეზობლად მდებარე კი არა. სეტყვის საწინააღმდეგო ღონისძიებები ითვალისწინებს: ღრუბლებში მარილის (მაგ. NaCl) გაფრქვევას, რაც თბილი წვეთების შეერთებას და წვიმის სახით წამოსვლას უწყობს ხელს. ბევრად ეფექტური და ეკოლოგიურად სუფთა საშუალებაა სასოფლო-სამეურნეო სავარგულების სეტყვის საწინააღმდეგო ბადეებით გადაფარვა.",
  ...
  education: {
    ...
    text: "",
    author: 
      "გულიკო ლიპარტელიანი, ანი შეროზია",
    source:
      "მუნ. რესურსცენტრები, 2023–2024; განათლების, მეცნ. და ახ. სამინისტრო",
  },
  kindergarten: {
    title: 
      "საჯარო სკოლამდელი აღზრდისა და განათლების დაწესებულებები",
    text: 
      "სკოლამდელი აღზრდის დაწესებულებებს მნიშვნელოვანი როლი აკისრიათ სკოლამდელი ასაკის ბავშვების ჰარმონიულ განვითარებასა და სკოლისთვის მომზადებაში. აქ ეყრება საფუძველი ბავშვების ფიზიკურ და ინტელექტუალურ განვითარებას, შემეცნებითი და შემოქმედებითი უნარების ფორმირებას და გამოხატვას, ესთეტიკური გემოვნების ჩამოყალიბებას. მათი განხორციელებისთვის საჭიროა შესაბამისი დაწესებულება და აღსაზრდელ/აღმზრდელების გონივრული თანაფარდობა. 2017/2018 სასწავლო წელს, ქვემო ქართლის რეგიონში იყო 104 საჯარო სკოლამდელი აღზრდისა და განათლების დაწესებულება, რომელსაც ჰყავდა 14 058 აღსაზრდელი და 869 აღმზრდელი. 2022/2023 სასწავლო წელს ეს რიცხვები შეიცვალა შემდეგნაირად: 122 დაწესებულება, 14 399 აღსაზრდელი, 1 241 აღმზრდელი, მათ შორის ინკლუზიური განათლების სპეციალური პედაგოგი. 2016 წლიდან, მოქმედი კანონით „სკოლამდელი აღზრდისა და განათლების შესახებ“, განსაზღვრულია შემდეგი სტანდარტები: ა) 2-დან 3 წლამდე ბავშვების ჯგუფში აღმზრდელ-პედაგოგების/აღმზრდელების ბავშვებთან თანაფარდობა არ უნდა იყოს 1:13-ზე მეტი; ბ) 3-დან 4 წლამდე ბავშვების ჯგუფში აღმზრდელ-პედაგოგების/აღმზრდელების ბავშვებთან თანაფარდობა არ უნდა იყოს 1:15-ზე მეტი; გ) 4-დან 5 წლამდე ბავშვების ჯგუფში აღმზრდელ-პედაგოგების/აღმზრდელების ბავშვებთან თანაფარდობა არ უნდა იყოს 1:15-ზე მეტი; დ) სასკოლო მზაობის პროგრამის ჯგუფში აღმზრდელ-პედაგოგების/აღმზრდელების ბავშვებთან თანაფარდობა არ უნდა იყოს 1:15-ზე მეტი.",
    author: "ნატო სოლოღაშვილი",
    source: 
      "საქსტატი; საქართველოს პრეზიდენტის №5366 ბრძანება, 2016",
  },
  oikonymy: {
    title: "ოიკონიმია",
    text: "",
  ...
  tourism_climate: {
    ...
    text:
      ...
      "ტურიზმის განვითარების ხელშეწყობის მიზნით, მსოფლიოს მრავალ ქვეყანაში აქტუალურია გარემოს საკურორტო-ტურისტული შეფასება. ადგილის ბიო-კლიმატური რესურსების განსაზღვრა ემყარება ადგილის ოროგრაფიის, კლიმატის (ჰავის), მცენარეული საფარის, ეკოლოგიური პირობების კვლევას. მათ შორის ძირითადი ფაქტორებია ამინდი და კლიმატი. მსოფლიოში ბიოკლიმატოლოგიის, ბიომეტეოროლოგიის და სამედიცინო მეტეოროლოგიის მიმართულებებით ჩატარებული მრავალი გამოკვლევის საფუძველზე კანადაში შემუშავდა დასვენების კლიმატური ინდექსი (დკი), რომელიც პოპულარული გახდა მრავალ ქვეყანაში. ქვემო ქართლის 8 ლოკაციისთვის დკი-ს მნიშვნელობები გამოთვლილია არსებული მეტეოროლოგიური სადგურის საჭირო კლიმატური მონაცემების საფუძველზე. ქვემო ქართლის ბიოკლიმატური პირობები ხელსაყრელია საკურორტო-ტურისტული ინდუსტრიისთვის მთელი წლის განმავლობაში.",
    author: 
  ...
  tourism_types: {
    ...
    text:
      ...
      "მატერიალური კულტურის და ბუნებრივი ძეგლების სიმრავლის მიუხედავად, ტურიზმის განვითარება ქვემო ქართლში გვიან დაიწყო. გამონაკლისს წარმოადგენს კურორტი მანგლისი, რომლის ათვისებასაც ხანგრძლივი ისტორია აქვს. რეგიონში ტურიზმის აღორძინებას ბიძგი მისცა დმანისში მსოფლიო მნიშვნელობის არქეოლოგიურმა აღმოჩენებმა, რასაც მოჰყვა კულტურულ-შემეცნებითი და სამეცნიერო ტურიზმის გააქტიურება და მხარის სხვა ისტორიული ძეგლების ჩართვა ამ პროცესში. არქეოლოგიური აღმოჩენები ქვემო ქართლში დღესაც გრძელდება (ქვემო ოროზმანი). ტერიტორიაზე, რომელიც ათასწლეულების მანძილზე წარმოადგენდა სხვადასხვა ცივილიზაციებისა და ხალხების თანაცხოვრების ადგილს, დიდი მნიშვნელობა შეიძინა ეთნოგრაფიულმა ტურიზმმა. ბუნებრივი რესურსების მრავალფეროვნებამ განაპირობა გამაჯანსაღებელი, ეკოლოგიური, სათავგადასავლო ტურიზმის განვითარების შესაძლებლობა. ტურისტული რესურსების ძირითადი მომხმარებელი ჯერჯერობით ადგილობრივი ტურისტები არიან, თუმცა, რეგიონი სულ უფრო იზიდავს უცხოელ ტურისტებსაც. ამ პროცესს ხელს უწყობს ტურისტული დესტინაციების (დანიშნულების ადგილების) კეთილმოწყობა და ტურისტული ინფრასტრუქტურის განვითარება.",
    author: 
      "მზია თუთბერიძე, სოფიო ხორბალაძე",
    cartographer: "",
    source:
  ...
  health_infra: {
    ...
    text: 
      "რეგიონის ჯანდაცვის სისტემა მუნიციპალიტეტების ცენტრებში განლაგებულ მრავალპროფილურ კლინიკებს და სოფლის ამბულატორიებს მოიცავს. ქალაქ რუსთავში რამდენიმე მნიშვნელოვანი კლინიკაა. სოფლის მოსახლეობის ჯანდაცვის მომსახურებების გაუმჯობესების მიზნით, იგეგმება სოფლის ამბულატორიების მშენებლობა და რეაბილიტაცია, სასწრაფო-სამედიცინო დახმარების ახალი ცენტრების აშენება. ეს მიზნად ისახავს მუნიციპალიტეტებში სასწრაფო-სამედიცინო დახმარების მომსახურებების ხელმისაწვდომობისა და ხარისხის გაუმჯობესებას. რეგიონში ასევე მოქმედებს ჯანმრთელობის ეროვნული სააგენტოს ქვემო ქართლის რეგიონული სამსახური, რომელიც ახორციელებს ჯანმრთელობის დაცვის სახელმწიფო პროგრამებს.",
    author: "სოფიო ხორბალაძე",
    source: 
      "მუნიციპალიტეტების ჯანდაცვის სამსახურები",
  },
  social: {
    title: "სოციალური დახმარება",
    text: 
      "ქვემო ქართლის რეგიონში 2023 წელს საარსებო შემწეობის მისაღებად დარეგისტრირებული ოჯახების რაოდენობა 2012 წელთან შედარებით, დაახლოებით 13%-ით შემცირდა, ხოლო საარსებო შემწეობის მიმღები ოჯახების რაოდენობა თითქმის 200%-ით გაიზარდა და შეადგინა შესაბამისად, 39 906 და 19 397 ერთეული. შეიძლება ითქვას, რომ დარეგისტრირებული ოჯახებიდან მხოლოდ 49% იღებს საარსებო შემწეობას. 2023 წლის მონაცემებით, საარსებო შემწეობის მისაღებად დარეგისტრირებული ოჯახების რაოდენობის მიხედვით, ლიდერობს ქალაქი რუსთავი (9228 ერთეული), ხოლო საარსებო შემწეობის მიმღები ოჯახების რაოდენობის მიხედვით — გარდაბნის მუნიციპალიტეტი (5287 ერთეული), რაც საერთო დარეგისტრირებული რაოდენობის 13%-ია. 2012 წლიდან ქვემო ქართლის რეგიონის მოსახლეობის რაოდენობა 105%-ით გაიზარდა და 2023 წელს 442 800 კაცი შეადგინა. პენსიის მიმღებთა რაოდენობა კი — 2020 წელს, 2012 წელთან შედარებით, 140%-ით გაიზარდა და მისი რაოდენობა 83 814 კაცი გახდა, რამაც რეგიონის მოსახლეობის საერთო რაოდენობის 19% შეადგინა. აღნიშნულ პერიოდში ასევე გაიზარდა სოციალური პაკეტის მიმღებთა რაოდენობა და 2023 წელს შეადგინა 15 697 კაცი, რაც მოსახლეობის 4%-ია. სახელმწიფო ბიუჯეტის შესახებ კანონის შესაბამისად, 2012 წლის 1 სექტემბრიდან, „პენსიის“ მიმღებთა ჯგუფში ერთიანდებიან მხოლოდ ასაკით პენსიონერები, ხოლო ყველა დანარჩენი „სოციალური პაკეტის“ მიმღებთა ჯგუფშია.",
    author: "ნატო სოლოღაშვილი",
    source: "საქსტატი",
  },
  zoo_anthrax: {
    title: "ჯილეხი",
    text: 
      "ჯილეხი ზოონოზური (ცხოველური), მწვავე ინფექციური დაავადებაა. მას იწვევს ბაქტერია Bacillus anthracis, რომლის სპორები წლობით ძლებს ნიადაგში. კვლევებმა ცხადყო, რომ ჯილეხის გავრცელების მთავარი კერა ნიადაგია. ავადდებიან ბალახისმჭამელი შინაური ცხოველები. დაავადების გავრცელებას ხელს უწყობენ მწერები. ჯილეხით დაავადებას ადამიანებში იწვევს კანით კონტაქტი, სპორების შესუნთქვა ან ბაქტერიით დაბინძურებული ხორცით კვება. შინაურ ცხოველებს დაავადებისგან იცავს აცრა. საქართველოში ჯილეხის გამოვლენის შემთხვევა ყველაზე მაღალია ქვემო ქართლსა და კახეთში, სადაც ჰუმუსით მდიდარი ყავისფერი, ალუვიური და შავმიწა ნიადაგები ხელსაყრელ პირობებს ქმნიან გარემოში ჯილეხის სპორების ხანგრძლივი არსებობისათვის. წყალდიდობები ზრდის ჯილეხის გავრცელების რისკს.",
    author: "თამარ ჭიჭინაძე",
    source: 
      "დაავადებათა კონტროლის ეროვნული ცენტრი; საქართველოს ნიადაგების რუკა, 2019",
  },
  zoo_other: {
    title: "ბრუცელოზი, ტულარემია, ენცეფალიტი, ლეპტოსპიროზი",
    text: 
      "ბრუცელოზი — ინფიცირებულ ცხოველთან კონტაქტით; ტულარემია — ტკიპისა და ბუზის ნაკბენით; ენცეფალიტი — ტკიპა და კოღო; ლეპტოსპიროზი — მღრღნელები; ყირიმ-კონგოს ჰემორაგიული ცხელება — Hyalomma-ს გვარის ტკიპა.",
    author: "თამარ ჭიჭინაძე",
    source: 
      "დაავადებათა კონტროლის ცენტრი, 1950-2019; ზოონოზური ინფექციების ატლასი სამხრეთ კავკასიაში",
  },
};
  ...
  layerRef.layer = L.geoJSON(data, {
    style: function (feat) {
      return {
        ...
        fillOpacity: 0.72,
        // თხელი კონტური იმავე ფერის მუქ ტონში — ერთნაირი
        // მეზობელი პოლიგონებიც კარგად გამოიყოფა
        color: noBorder ? darken(feat.properties.LandColor) : "#888",
        weight: noBorder ? 0.5 : 0.5,
        opacity: noBorder ? 0.85 : 0.7,
      };
    },
    onEachFeature: function (feature, layer) {
      var p = feature.properties;
...
document.getElementById("chkNature").addEventListener("change", function (e) {
  if (e.target.checked) {
    ...
    document
      .querySelector("[data-naturesub='geology']")
      .classList.add("active");
    loadGeology();
    setInfoBtn(NATURE_SUB_INFO.geology);
    document.getElementById("filterSection").style.display = "none";
    document.getElementById("infoCard").classList.add("hidden");
  } else {
...
var NATURE_SUB_INFO = {
  ...
  hydro: "hydro",
  landscape: "landscape",
  landscape_antrop: "landscape_antrop",
  hazard: "hazard",
...
function updateHailLegend(type) {
  ...
  <div style="margin-top:10px;">
    ...
    <div style="display:flex;gap:6px;">
      <button class="year-btn ${type === "total" ? "active" : ""}" data-hailtype="total" title="საერთო დაზიანებული ფართობი ერთი სეტყვიანობის შემთხვევაზე">საერთო</button>
      <button class="year-btn ${type === "100" ? "active" : ""}" data-hailtype="100" title="100%-ით დაზიანებული ფართობი ერთი სეტყვიანობის შემთხვევაზე">100%</button>
    </div>
  </div>`;
...
var BOTANICA_TYPES = [
  { key: "ვენახ-ხილიანი", color: "#8DCB8B", label: "ვენახ-ხილიანი" },
  { key: "უვენახ-ხილო", color: "#FEE182", label: "უვენახ-ხილო" },
  { key: "ბრინჯ-ბამბა", color: "#6ECCDE", label: "ბრინჯ-ბამბა" },
  { key: "ბალახ-ყვავილოვანი", color: "#F0C1DA", label: "ბალახ-ყვავილოვანი" },
  { key: "ზამთრის საძოვრები", color: "#FCBA7D", label: "ზამთრის საძოვრები" },
];
...
var CROP_ZONES = [
  ...
  { key: "სათიბ-საძოვრების ზონა", color: "#C3AC3B", short: "სათიბ-საძოვრები" },
];
